// Concatenated JavaScript file for docs/v3
// This file was created because middleman-sprockets conflicts with Middleman 4.6+ Sass rendering
//
// To regenerate this file, run from docs/v3 directory:
//   cat source/javascripts/lib/_energize.js > source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   cat source/javascripts/lib/_dropdown.js >> source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   cat source/javascripts/lib/_lunr.js >> source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   tail -n +2 source/javascripts/app/_search.js >> source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   cat source/javascripts/lib/_jquery_ui.js >> source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   cat source/javascripts/lib/_jquery.tocify.js >> source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   cat source/javascripts/lib/_imagesloaded.min.js >> source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   tail -n +4 source/javascripts/app/_toc.js >> source/javascripts/all.js && \
//   echo ";" >> source/javascripts/all.js && \
//   cat source/javascripts/app/_version_dropdown.js >> source/javascripts/all.js
