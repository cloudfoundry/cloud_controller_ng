# -*- encoding: utf-8 -*-
# stub: azure_mgmt_sql 0.9.0 ruby lib

Gem::Specification.new do |s|
  s.name = "azure_mgmt_sql".freeze
  s.version = "0.9.0"
  ...
  s.date = "2017-02-07"
  s.description = "Microsoft Azure SQL Management Client Library for Ruby".freeze
  s.email = "azrubyteam@microsoft.com".freeze
  s.homepage = "https://aka.ms/azure-sdk-for-ruby".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.0.0".freeze)
  s.rubygems_version = "3.4.19".freeze
  s.summary = "Official Ruby client library to consume Microsoft Azure SQL Management services.".freeze
