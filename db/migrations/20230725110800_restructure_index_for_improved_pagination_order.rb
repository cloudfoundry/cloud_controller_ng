Sequel.migration do
  index_migration_data = [
    ...
    # DESIRED_STATE
    {
      ...
      new_columns: %i[desired_state guid]
    },
    # POSITION
    {
      table: :buildpacks,
