Sequel.migration do
  change do
    create_table :app_security_groups_spaces do
      ...
      foreign_key [:app_security_group_id], :app_security_groups, :name => :fk_spaces_asgs_app_security_group_id

      Integer :space_id, :null => false
      foreign_key [:space_id], :spaces, :name => :fk_spaces_asgs_space_id
