Sequel.migration do
  change do
    create_table :service_instance_shares do
      ...
      foreign_key [:service_instance_guid], :service_instances, key: :guid, name: :fk_service_instance_guid
      foreign_key [:target_space_guid], :spaces, key: :guid, name: :fk_target_space_guid
