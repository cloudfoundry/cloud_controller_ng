...
#
# As the previous set of migrations evolved, they ended up dropping columns
# as the schema was changed  to support new/changing feature sets. However,
# some of these columns had constraints, including foreign key constraints.
# While sqlite and postgres will allow you to drop a column with an existing
...
# However, the standard usage of the sequel migrations is to just accept
...
# of the sequel migrations.  Obviously, that would be very brittle.
#
...
Sequel.migration do
  ...
  change do
    ...
    create_table :apps do
      ...
      # Do the bare minimum for now.  We'll migrate this to something
