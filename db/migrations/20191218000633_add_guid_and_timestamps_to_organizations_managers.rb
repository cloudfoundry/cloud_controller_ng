Sequel.migration do
  up do
    unless self[:organizations_managers].columns.include?(:role_guid)
      alter_table :organizations_managers do
        ...
        add_index :role_guid, name: :organizations_managers_role_guid_index
  ...
  down do
    alter_table :organizations_managers do
      drop_index :updated_at, name: :organizations_managers_role_guid_index
      drop_index :created_at, name: :organizations_managers_created_at_index
      drop_index :role_guid, name: :organizations_managers_updated_at_index
