...
RSpec.resource 'Buildpacks', type: [:api, :legacy_api] do
  ...
  describe 'Standard endpoints' do
    shared_context 'updatable_fields' do |opts|
      ...
      field :stack, 'The name of the stack to associate this buildpack with', example_values: ['cflinuxfs3']
    ...
    post '/v2/buildpacks' do
      ...
      example 'Creates an admin Buildpack' do
        client.post '/v2/buildpacks', fields_json(stack: 'cflinuxfs3'), headers
