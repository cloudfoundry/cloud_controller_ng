...
resource 'Space Quota Definitions', type: [:api, :legacy_api] do
  ...
  shared_context 'updatable_fields' do |opts|
    ...
    field :disk_limit, 'How much disk space in megabytes a space can have.', required: opts[:required], example_values: [5_120, 10_024]
    ...
    field :instance_disk_limit,
      'The maximum amount of disk space in megabytes an application instance can have. (-1 represents an unlimited amount)',
      default: -1,
      example_values: [-1, 10_024]
