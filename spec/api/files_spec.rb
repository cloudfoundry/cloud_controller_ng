      ...
      context "as a developer" do
        ...
        context "dea returns file uri v1" do
          it "should return 400 when accessing of the file URL fails" do
            ...
            client.should_receive(:get).with("file_uri/", :header => {}).
              and_return(response)
          ...
          it "should return the expected files when path is specified" do
            ...
            response = mock("http response")
            client.should_receive(:get).with("file_uri/path", :header => {}).
              and_return(response)
          ...
          it "should forward the http range request" do
            ...
            client.should_receive(:get).
              with("file_uri/", :header => { "range" => range } ).
              and_return(response)
        ...
        context "dea returns file uri v2" do
          it "should issue redirect when file uri v2 is returned by the dea" do
            instance_id = 5
            range = "bytes=100-200"
