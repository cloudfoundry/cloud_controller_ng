  ...
  describe VCAP::CloudController::ServiceInstancesController, :services, type: :controller do
    ...
    describe 'POST', '/v2/service_instance' do
      ...
      context 'with a provisioner' do
        ...
        before do
          Models::ServiceProvisioner.stub(:new).and_return(provisioner)
        ...
        it 'provisions a service instance' do
          ...
          instance = Models::ServiceInstance.last
        ...
        it 'deprovisions the service instance when an exception is raised' do
          ...
          Models::ManagedServiceInstance.any_instance.stub(:save).and_raise
          Models::ManagedServiceInstance.any_instance.should_receive(:deprovision_on_gateway)
    ...
    describe 'GET', '/v2/service_instances' do
      let(:space) { Models::Space.make }
      let(:developer) { make_developer_for_space(space) }
      let(:service_instance) { Models::ManagedServiceInstance.make(gateway_name: Sham.name) }
