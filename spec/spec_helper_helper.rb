module SpecHelperHelper
  ...
  # rubocop:disable Metrics/MethodLength, Metrics/AbcSize, RSpec/BeforeAfterAll
  def self.each_run
  ...
  # rubocop:enable Metrics/MethodLength, Metrics/AbcSize, RSpec/BeforeAfterAll
end
