...
RSpec.describe 'Events' do
  describe 'GET /v3/audit_events' do
    ...
    let!(:org_scoped_event) { VCAP::CloudController::Event.make(created_at: Time.now.utc + 100, type: 'audit.organization.create', actee: org.guid, organization_guid: org.guid) }
