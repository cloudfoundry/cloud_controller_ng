...
RSpec.describe 'Apps' do
  ...
  describe 'GET /v3/apps/:guid' do
    ...
    before do
      ...
      app_model.add_process(create(:process, instances: 1))
      app_model.add_process(create(:process, instances: 2))
    end
  ...
  describe 'PATCH /v3/apps/:guid' do
    ...
    let!(:web_process) { create(:process, app: app_model, state: VCAP::CloudController::ProcessModel::STOPPED) }
    ...
    context 'when the app has a process that is started' do
      let!(:web_process) { create(:process, app: app_model, state: VCAP::CloudController::ProcessModel::STARTED) }
    ...
    context 'app lifecycle is buildpack' do
      ...
      context 'starting an app' do
        ...
        describe 'limiting the application log rates' do
          ...
          let!(:process_model) { create(:process, app: app_model, log_rate_limit: log_rate_limit) }
          let(:app_model) do
            create(:app_model,
                   name: 'app-name',
                   space: space,
