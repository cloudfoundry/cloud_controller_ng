...
RSpec.describe 'Apps' do
  ...
  describe 'GET /v2/apps' do
    ...
    context 'with inline-relations-depth' do
      ...
      def verify_inline_stack_data(stack_data)
        ...
        expect(stack_data['entity']['deprecated_at']).to be_nil
        expect(stack_data['entity']['locked_at']).to be_nil
        expect(stack_data['entity']['disabled_at']).to be_nil
      end
  ...
  describe 'POST /v2/apps/:guid/copy_bits' do
    let!(:source_process) { VCAP::CloudController::ProcessModelFactory.make(space:) }
