...
RSpec.describe 'migration to add unique index on service_instance_id to service_instance_operations', isolation: :truncation, type: :migration do
  ...
  it 'removes duplicate service instance operations' do
    ...
    # none of them should be removed.
    si1 = create(:service_instance)
    create(:service_instance_operation, service_instance_id: si1.id)
    si2 = create(:service_instance)
    create(:service_instance_operation, service_instance_id: si2.id)
    ...
    si3 = create(:service_instance)
    o1 = create(:service_instance_operation, service_instance_id: si3.id)
    o2 = create(:service_instance_operation, service_instance_id: si3.id)
    o3 = create(:service_instance_operation, service_instance_id: si3.id)
    ...
    si4 = create(:service_instance)
    o4 = create(:service_instance_operation, service_instance_id: si4.id)
    o5 = create(:service_instance_operation, service_instance_id: si4.id)
    o6 = create(:service_instance_operation, service_instance_id: si4.id)
