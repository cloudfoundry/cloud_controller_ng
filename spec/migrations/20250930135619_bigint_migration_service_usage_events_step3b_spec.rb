...
RSpec.describe 'bigint migration - service_usage_events table - step3b', isolation: :truncation, type: :migration do
  include_context 'bigint migration step3b' do
    ...
    let(:migration_filename_step3b) { '20250930135619_bigint_migration_service_usage_events_step3b.rb' }
