    ...
    describe '#start' do
      ...
      it 'schedules cleanup for all daily jobs' do
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'app_usage_events', at: '18:00', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'audit_events', at: '20:00', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'failed_jobs', at: '21:00', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'service_usage_events', at: '22:00', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'completed_tasks', at: '23:00', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'expired_blob_cleanup', at: '00:00', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'expired_resource_cleanup', at: '00:30', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'expired_orphaned_blob_cleanup', at: '01:00', priority: 0, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'orphaned_blobs_cleanup', at: '01:30', priority: 1, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_daily_job) do |args, &block|
          expect(args).to eql(name: 'pollable_job_cleanup', at: '02:00', priority: 0, timeout: global_timeout)
      ...
      it 'schedules the frequent worker jobs' do
        ...
        expect(clock).to receive(:schedule_frequent_worker_job) do |args, &block|
          expect(args).to eql(name: 'pending_droplets', interval: 300, timeout: global_timeout)
        ...
        expect(clock).to receive(:schedule_frequent_worker_job) do |args, &block|
          expect(args).to eql(name: 'pending_builds', interval: 400, timeout: global_timeout)
