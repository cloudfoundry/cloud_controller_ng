  ...
  describe VCAP::CloudController::Dea::HM9000::LegacyClient do
    ...
    describe 'batching bulk api requests to avoid exceeding nats message length' do
      ...
      context 'when the application list is less than or equal to APP_STATE_BULK_MAX' do
        before { stub_const('VCAP::CloudController::Dea::HM9000::LegacyClient::APP_STATE_BULK_MAX_APPS', 3) }
      ...
      context 'when the applications list is longer than APP_STATE_BULK_MAX' do
        before { stub_const('VCAP::CloudController::Dea::HM9000::LegacyClient::APP_STATE_BULK_MAX_APPS', 2) }
