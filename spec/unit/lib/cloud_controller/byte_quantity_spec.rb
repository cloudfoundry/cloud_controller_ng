  ...
  RSpec.describe ByteQuantity do
    ...
    describe "#to_bytes" do
      ...
      it "parses byte amounts that are float (e.g. 5.3KB)" do
        expect(ByteQuantity.to_bytes("13.5KB")).to eq(13824)
      ...
      context "raises an error" do
        it "when the unit is missing" do
          ...
          }.to raise_error(ByteQuantity::InvalidByteQuantityError)
        end
    ...
    describe "#to_megabytes" do
      it "parses byte amounts with short units (e.g. M, G)" do
        ...
        expect(ByteQuantity.to_megabytes("5T")).to eq(5242880)
      end
      ...
      it "parses byte amounts with long units (e.g MB, GB)" do
        ...
        expect(ByteQuantity.to_megabytes("5TB")).to eq(5242880)
      end
      ...
      it "parses byte amounts with long binary units (e.g MiB, GiB)" do
        ...
        expect(ByteQuantity.to_megabytes("5TiB")).to eq(5242880)
      end
