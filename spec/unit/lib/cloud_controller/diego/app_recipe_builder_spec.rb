      ...
      describe '#build_app_lrp' do
        ...
        context 'when the lifecycle_type is "buildpack"' do
          ...
          it 'creates a desired lrp' do
            ...
            expect(lrp.metric_tags.size).to eq(5)
            ...
            expect(lrp.metric_tags[4].key).to eq('cf_process_instance_id')
            expect(lrp.metric_tags[4].value.dynamic).to eq(::Diego::Bbs::Models::MetricTagValue::DynamicValue::INSTANCE_GUID)
