  ...
  module ServiceBrokers
    module V2
      describe 'ResponseParser' do
        ...
        test_case(:deprovision, 204, broker_partial_json,                            result: {})
        test_case(:deprovision, 204, broker_malformed_json,                          result: {})
        test_case(:deprovision, 204, broker_empty_json,                              result: {})
