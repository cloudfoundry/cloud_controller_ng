...
RSpec.describe VCAP::WasRunningBackfill do
  ...
  describe '.skip?' do
    context 'when skip_was_running_backfill is false' do
      before { TestConfig.override(skip_was_running_backfill: false) }
    ...
    context 'when skip_was_running_backfill is true' do
      before { TestConfig.override(skip_was_running_backfill: true) }
    ...
    context 'when skip_was_running_backfill is not set' do
      before { TestConfig.reset }
