  ...
  RSpec.describe FieldServiceInstanceOfferingDecorator do
    describe '.decorate' do
      ...
      it 'can decorate with the service offering name' do
        ...
        decorator = described_class.new({ 'service_plan.service_offering': %w[name foo] })
      ...
      it 'can decorate with the service offering guid' do
        undecorated_hash = { foo: 'bar', included: { monkeys: %w[zach greg] } }
        decorator = described_class.new({ 'service_plan.service_offering': %w[guid foo] })
      ...
      it 'can decorate with the service offering description' do
        undecorated_hash = { foo: 'bar', included: { monkeys: %w[zach greg] } }
        decorator = described_class.new({ 'service_plan.service_offering': %w[description foo] })
      ...
      it 'can decorate with the service offering documentation' do
        undecorated_hash = { foo: 'bar', included: { monkeys: %w[zach greg] } }
        decorator = described_class.new({ 'service_plan.service_offering': %w[documentation_url foo] })
      ...
      it 'can decorate with the service offering tags' do
        undecorated_hash = { foo: 'bar', included: { monkeys: %w[zach greg] } }
        decorator = described_class.new({ 'service_plan.service_offering': %w[tags foo] })
