...
module VCAP::CloudController
  RSpec.describe ServiceInstanceDelete do
    ...
    describe '#delete' do
      context 'with pre-existing instances and bindings' do
        ...
        it 'deletes associated labels' do
          ...
          expect(labels).to be_none(&:exists?)
        end
        ...
        it 'deletes associated annotations' do
          ...
          expect(annotations).to be_none(&:exists?)
        end
        ...
        it 'deletes user provided service instances' do
          ...
          expect(user_provided_instance).not_to exist
        end
        ...
        it 'deletes the last operation for each managed service instance' do
          ...
          expect(route_service_instance).not_to exist
          expect(instance_operation_1).not_to exist
        end
        ...
        context 'when unbinding a service instance fails' do
          ...
          it 'leaves the service instance unchanged' do
            ...
            expect(service_binding_1).to exist
          end
        end
        ...
        context 'when a service instance has a create operation in progress' do
          ...
          context 'when service instance deprovision happen to be synchronous' do
            ...
            it 'deletes the instance and tells broker to deprovision and returns no errors' do
              ...
              expect(ServiceInstance.where(id: service_instance.id).count).to eq 0
          ...
          context 'when service instance deprovision happen to be asynchronous' do
            ...
            it 'passes the accepts_incomplete flag, updates the instance to be in progress, and enqueues a fetch job' do
            ...
            context 'when there is an error during service instance delete' do
              ...
              it 'does not update the operation type and returns errors' do
        ...
        context 'when the broker returns an error for route unbinding' do
          ...
          it 'does not attempt to delete that service instance' do
            service_instance_delete.delete(service_instance_dataset)
            expect(route_service_instance).to exist
            expect(managed_service_instance).not_to exist
        ...
        context 'when the broker returns an error for unbinding' do
          ...
          it 'does not attempt to delete that service instance' do
            service_instance_delete.delete(service_instance_dataset)
            expect(route_service_instance).not_to exist
            expect(managed_service_instance).to exist
