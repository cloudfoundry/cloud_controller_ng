...
module VCAP::CloudController
  RSpec.describe UpdateRouteDestinations do
    ...
    let!(:process1) { create(:process_model, :process, guid: 'process1-guid', app: app_model, type: 'web', health_check_type: 'none') }
    let!(:process2) { create(:process_model, :process, guid: 'process2-guid', app: app_model2, type: 'worker', health_check_type: 'none') }
    let!(:process3) { create(:process_model, :process, guid: 'process3-guid', app: app_model, type: 'existing', health_check_type: 'none', ports: [3001]) }
    let!(:docker_process) { create(:process_model, :process, app: docker_app, type: 'web') }
