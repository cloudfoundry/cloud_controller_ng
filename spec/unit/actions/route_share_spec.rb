  ...
  RSpec.describe RouteShare do
    ...
    describe '#delete' do
      ...
      it 'deletes share' do
        ...
        modified_route = route_share.delete(route, target_space2, user_audit_info)
        # The target_space variable will not refresh its routes anymore after we added a call to grab the shared routes with the space to the
        # Validation of shared routes. If we just reload the target_space1 object we can get the new version of target_space1 & 2's shared routes.
        target_space1.reload
        target_space2.reload
      ...
      it 'records a share event' do
        ...
        route_share.delete(route, target_space2, user_audit_info)
      end
      ...
      context 'when unsharing a space fails' do
        ...
        it 'does not unshare the space' do
          ...
          expect {
            route_share.delete(route, target_space1, user_audit_info)
          }.to raise_error('db failure')
      ...
      context 'when attempting to unshare the owning space' do
        it 'does not permit you to unshare that space' do
          expect {
            route_share.delete(route, route.space, user_audit_info)
          }.to raise_error(VCAP::CloudController::RouteShare::Error,
