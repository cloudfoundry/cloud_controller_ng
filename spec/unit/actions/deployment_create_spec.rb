...
module VCAP::CloudController
  RSpec.describe DeploymentCreate do
    ...
    let!(:web_process) { create(:process_model, app: app, instances: original_instances, memory: 500, disk_quota: 1024, log_rate_limit: 101, state: process_state) }
      ...
      context 'when a droplet is provided on the message' do
          ...
          context 'when the app is stopped' do
            ...
            context 'uses the web_instances from the message' do
              ...
              context 'quota validations' do
                let!(:web_process) { create(:process_model, app: app, instances: 3, memory: 999) }
        ...
        context 'when the same droplet is provided (zdt-restart)' do
          ...
          context 'uses the web_instances from the message' do
            ...
            context 'quota validations' do
              let!(:web_process) { create(:process_model, app: app, instances: 3, memory: 999, state: 'STOPPED') }
          ...
          context 'uses the memory_in_mb from the message' do
            ...
            context 'quota validations' do
              let!(:web_process) { create(:process_model, app: app, instances: 3, memory: 999, state: process_state) }
          ...
          context 'uses the disk_in_mb from the message' do
            ...
            context 'quota validations' do
              let!(:web_process) { create(:process_model, app: app, instances: 3, disk_quota: 999, state: process_state) }
          ...
          context 'uses the log_rate_limit_in_bytes_per_second from the message' do
            ...
            context 'quota validations' do
              let!(:web_process) { create(:process_model, app: app, instances: 3, log_rate_limit: 999, memory: 999, state: process_state) }
