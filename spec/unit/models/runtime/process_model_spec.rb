  ...
  RSpec.describe ProcessModel, type: :model do
    ...
    describe 'Validations' do
      ...
      describe 'buildpack' do
        ...
        it 'does allow nil value' do
          process.app.lifecycle_data.update(buildpack: nil)
          expect {
            process.save
          }.to_not raise_error
        end
        ...
        it 'does allow a public url' do
          process.app.lifecycle_data.update(buildpack: 'git://user@github.com/repo.git')
          expect {
            process.save
          }.to_not raise_error
        end
        ...
        it 'allows a public http url' do
          process.app.lifecycle_data.update(buildpack: 'http://example.com/foo')
          expect {
            process.save
          }.to_not raise_error
        end
        ...
        it 'allows a buildpack name' do
          ...
          process.app.lifecycle_data.update(buildpack: admin_buildpack.name)
          expect {
            process.save
          }.to_not raise_error
        ...
        it 'does not allow a non-url string' do
          process.app.lifecycle_data.update(buildpack: 'Hello, world!')
          expect {
            process.save
    ...
    describe '#buildpack_cache_key' do
      ...
      it 'compose the buildpack cache key from stack name and app guid' do
        process.save
        process.refresh
        expect(process.buildpack_cache_key).to eq("#{process.guid}/#{process.stack.name}")
      end
    end
    ...
    describe 'custom_buildpack_url' do
      ...
      context 'when a custom buildpack is associated with the app' do
        it 'should be the custom url' do
          process.app.lifecycle_data.update(buildpack: 'https://example.com/repo.git')
      ...
      context 'when an admin buildpack is associated with the app' do
        it 'should be nil' do
          process.app.lifecycle_data.update(buildpack: Buildpack.make.name)
