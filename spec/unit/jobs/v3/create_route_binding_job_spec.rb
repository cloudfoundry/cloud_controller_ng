...
module VCAP::CloudController
  module V3
    RSpec.describe CreateRouteBindingJobActor do
      let(:subject) do
        described_class.new
      end
      ...
      describe '#new_action' do
        it 'returns a ServiceRouteBindingCreate action' do
          expect(subject.new_action({}, {})).to be_instance_of(V3::ServiceRouteBindingCreate)
        end
      end
    end
