    ...
    RSpec.describe PendingDropletCleanup, job_context: :worker do
      ...
      describe '#perform' do
        ...
        context 'with droplets which have been staging or processing upload for too long' do
          let!(:droplet1) { create(:droplet_model, state: DropletModel::STAGING_STATE, set_as_current_droplet: false) }
          let!(:droplet2) { create(:droplet_model, state: DropletModel::STAGING_STATE, set_as_current_droplet: false) }
          let!(:droplet3) { create(:droplet_model, state: DropletModel::PROCESSING_UPLOAD_STATE, set_as_current_droplet: false) }
        ...
        it 'ignores droplets that have not been staging or processing upload for too long' do
          droplet1 = create(:droplet_model, state: DropletModel::STAGING_STATE, set_as_current_droplet: false)
          droplet2 = create(:droplet_model, state: DropletModel::STAGING_STATE, set_as_current_droplet: false)
          droplet3 = create(:droplet_model, state: DropletModel::PROCESSING_UPLOAD_STATE, set_as_current_droplet: false)
        ...
        it 'ignores droplets in a completed state' do
          droplet1 = create(:droplet_model, state: DropletModel::EXPIRED_STATE, set_as_current_droplet: false)
          droplet2 = create(:droplet_model, state: DropletModel::STAGED_STATE, set_as_current_droplet: false)
          droplet1.this.update(updated_at: expired_time)
          droplet2.this.update(updated_at: expired_time)
