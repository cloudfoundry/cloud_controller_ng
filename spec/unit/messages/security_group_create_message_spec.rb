...
module VCAP::CloudController
  RSpec.describe SecurityGroupCreateMessage do
    ...
    #       let(:params) { { name: 'B' * SecurityGroupCreateMessage::MAX_SPACE_QUOTA_NAME_LENGTH, relationships: relationships } }

    #       it { is_expected.to be_valid }
    #     end

    #     context 'when it is too long' do
    #       let(:params) { { name: 'B' * (SecurityGroupCreateMessage::MAX_SPACE_QUOTA_NAME_LENGTH + 1), relationships: relationships } }
