...
module VCAP::CloudController
  describe ServicePlanVisibilitiesController, :services do
    ...
    describe 'Permissions' do
      ...
      def self.user_sees_forbidden_enumerate(user_role, member_a_ivar, member_b_ivar)
      ...
      user_sees_forbidden_enumerate('Developer',      :@space_a_developer,     :@space_b_developer)
      user_sees_forbidden_enumerate('OrgManager',     :@org_a_manager,         :@org_b_manager)
      user_sees_forbidden_enumerate('OrgUser',        :@org_a_member,          :@org_b_member)
      user_sees_forbidden_enumerate('BillingManager', :@org_a_billing_manager, :@org_b_billing_manager)
      user_sees_forbidden_enumerate('Auditor',        :@org_a_auditor,         :@org_b_auditor)
      user_sees_forbidden_enumerate('SpaceManager',   :@space_a_manager,       :@space_b_manager)
      user_sees_forbidden_enumerate('SpaceAuditor',   :@space_a_auditor,       :@space_b_auditor)

      describe 'admin' do
        let(:member_a) { instance_variable_get(:@cf_admin) }
        let(:member_b) { instance_variable_get(:@cf_admin) }
