...
module VCAP::CloudController
  RSpec.describe VCAP::CloudController::ServiceInstancePurger do
    let(:event_repository) { VCAP::CloudController::Repositories::ServiceEventRepository.new(UserAuditInfo.new(user_guid: FactoryBot.create(:user).guid, user_email: 'email')) }
