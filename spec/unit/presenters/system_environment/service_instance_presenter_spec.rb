  ...
  describe '#to_hash' do
    ...
    context 'for a managed service instance' do
      let(:service_instance) do
        create(:managed_service_instance, service_plan: service_plan, tags: ['meow'])
      end
      ...
      let(:service) { create(:service, tags: %w[relational mysql]) }
    ...
    context 'for a provided service instance' do
      let(:service_instance) { create(:user_provided_service_instance, tags: %w[wonderful the-best]) }
