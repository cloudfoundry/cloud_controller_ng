  ...
  RSpec.describe ServiceUsageEventListFetcher do
    ...
    describe '#fetch_all' do
      ...
      it 'returns all of the events' do
        ...
        expect(subject).to contain_exactly(service_usage_event, service_usage_event_2, service_usage_event_3)
      end
      ...
      context 'filtering by after_guid' do
        ...
        it 'returns filtered events' do
          expect(subject).to contain_exactly(service_usage_event_3)
        end
      ...
      context 'filtering by guid' do
        ...
        it 'returns filtered events' do
          expect(subject).to contain_exactly(service_usage_event)
        end
      end
      ...
      context 'filtering by service_instance_type' do
        ...
        it 'returns filtered events' do
          expect(subject).to contain_exactly(service_usage_event_2)
        end
      end
