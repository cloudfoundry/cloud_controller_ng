  ...
  RSpec.describe BaseListFetcher do
    ...
    describe '#fetch_all' do
      ...
      context 'filtering guids' do
        let!(:event_1) { create(:event, guid: '1') }
        let!(:event_2) { create(:event, guid: '2') }
      ...
      context 'filtering timestamps on creation' do
        let!(:event_1) { create(:event, guid: '1', created_at: '2020-05-26T18:47:01Z') }
        let!(:event_2) { create(:event, guid: '2', created_at: '2020-05-26T18:47:02Z') }
        let!(:event_3) { create(:event, guid: '3', created_at: '2020-05-26T18:47:03Z') }
        let!(:event_4) { create(:event, guid: '4', created_at: '2020-05-26T18:47:04Z') }
        ...
        context 'requesting events less than a timestamp' do
          ...
          context 'when there are events with subsecond timestamps' do
            let!(:event_between_3_and_4) { create(:event, guid: '3.5', created_at: '2020-05-26T18:47:03.5Z') }
        ...
        context 'requesting events equal to several timestamps' do
          let!(:event_5) { create(:event, guid: '5', created_at: '2020-05-26T18:47:05Z') }
          let(:filters) do
          ...
          context 'when there are events with subsecond timestamps' do
            let!(:event_between_2_and_3) { create(:event, guid: '2.5', created_at: '2020-05-26T18:47:02.5Z') }
      ...
      context 'filtering timestamps on update' do
        ...
        let!(:event_1) { create(:event, guid: '1', updated_at: '2020-05-26T18:47:01Z') }
        let!(:event_2) { create(:event, guid: '2', updated_at: '2020-05-26T18:47:02Z') }
        let!(:event_3) { create(:event, guid: '3', updated_at: '2020-05-26T18:47:03Z') }
        let!(:event_4) { create(:event, guid: '4', updated_at: '2020-05-26T18:47:04Z') }
        ...
        context 'requesting events less than a timestamp' do
          ...
          context 'when there are events with subsecond timestamps' do
            let!(:event_between_3_and_4) { create(:event, guid: '3.5', updated_at: '2020-05-26T18:47:03.5Z') }
        ...
        context 'requesting events equal to several timestamps' do
          let!(:event_5) { create(:event, guid: '5', updated_at: '2020-05-26T18:47:05Z') }
          let(:filters) do
          ...
          context 'when there are events with subsecond timestamps' do
            let!(:event_between_2_and_3) { create(:event, guid: '2.5', updated_at: '2020-05-26T18:47:02.5Z') }
