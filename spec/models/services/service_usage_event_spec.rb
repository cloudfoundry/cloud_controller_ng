...
module VCAP::CloudController
  describe ServiceUsageEvent, type: :model do
    ...
    describe "required attributes" do
      let(:required_attributes) { [:state, :org_guid, :space_guid, :space_name, :service_instance_guid, :service_instance_name, :service_plan_guid, :service_plan_name, :service_guid, :service_label] }
