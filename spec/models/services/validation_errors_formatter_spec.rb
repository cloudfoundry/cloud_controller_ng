...
module VCAP::CloudController
  describe ValidationErrorsFormatter do
    describe "#format(validation_errors)" do
      ...
      let(:service_1) { ServiceBroker::V2::CatalogService.new(service_broker, 'name' => 'service-1') }
      let(:service_2) { ServiceBroker::V2::CatalogService.new(service_broker, 'name' => 'service-2') }
      let(:plan_123) { ServiceBroker::V2::CatalogPlan.new(service_2, 'name' => 'plan-123') }
      let(:service_3) { ServiceBroker::V2::CatalogService.new(service_broker, 'name' => 'service-3') }
