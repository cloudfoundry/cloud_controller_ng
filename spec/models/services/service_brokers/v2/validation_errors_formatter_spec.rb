...
module VCAP::CloudController::ServiceBrokers::V2
  describe ValidationErrorsFormatter do
    describe "#format(validation_errors)" do
      ...
      let(:service_1) { CatalogService.new(service_broker, 'name' => 'service-1') }
      let(:service_2) { CatalogService.new(service_broker, 'name' => 'service-2') }
      let(:plan_123)  { CatalogPlan.new(service_2, 'name' => 'plan-123') }
      let(:service_3) { CatalogService.new(service_broker, 'name' => 'service-3') }
