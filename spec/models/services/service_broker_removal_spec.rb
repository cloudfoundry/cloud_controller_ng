require 'spec_helper'
require 'models/services/service_broker_removal'
...
module VCAP::CloudController
  describe ServiceBrokerRemoval do
    ...
    describe '#execute!' do
      before do
        allow(ServiceDashboardClient).to receive(:find_clients_claimed_by_broker)
        allow_any_instance_of(ServiceBrokers::V2::ServiceDashboardClientDiffer).to receive(:create_changeset).
