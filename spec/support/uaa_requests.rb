module UAARequests
  def self.stub_all
    ...
    WebMock::API.stub_request(:get, 'http://uaa.service.cf.internal/oauth/clients/dash-id').to_return(status: 404)

    # stub client create request
    WebMock::API.stub_request(:post, 'http://uaa.service.cf.internal/oauth/clients/tx/modify').to_return(
      status:  201,
