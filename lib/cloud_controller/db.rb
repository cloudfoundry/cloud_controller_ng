module VCAP::CloudController
  class DB
    ...
    def self.load_models(db_config, logger)
      ...
      require "models/services/service_brokers/v1"
      require "models/services/service_brokers/v1/client"
      require "models/services/service_brokers/v1/http_client"
      require "models/services/service_brokers/v2"
      require "models/services/service_brokers/v2/client"
      require "models/services/service_brokers/v2/http_client"
      require "models/services/service_brokers/user_provided"
      require "models/services/service_brokers/user_provided/client"
