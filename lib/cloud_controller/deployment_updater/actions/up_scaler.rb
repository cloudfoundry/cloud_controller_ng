  ...
  module DeploymentUpdater
    module Actions
      class UpScaler
        ...
        def initialize(deployment, logger, interim_desired_instance_count, routable_instances_count, starting_instances_count, unhealthy_instances_count)
          @deployment = deployment
          @app = deployment.app
          @logger = logger
          @interim_desired_instance_count = interim_desired_instance_count
          @starting_instances_count = starting_instances_count
          @unhealthy_instances_count = unhealthy_instances_count
          @routable_instances_count = routable_instances_count
        end
