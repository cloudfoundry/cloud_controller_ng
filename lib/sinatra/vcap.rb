...
module Sinatra
  module VCAP
    ...
    def self.registered(app)
      ...
      app.not_found do
        body_from_vcap_exception(::VCAP::RestAPI::NotFound.new)
      end
      ...
      app.error do
        ...
        if is_vcap_error?(exception)
          ...
          body_from_vcap_exception(::VCAP::RestAPI::ServerError.new)
          status(500)
        end
      end
    end
    ...
    #
    # @option [String] :logger_name Name of the VCAP logger to use.  Defaults
    # to vcap.rest_api
    #
    # @option [String] :reload_path If specified and the app is running in
