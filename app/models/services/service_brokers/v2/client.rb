module VCAP::CloudController
  class ServiceBrokers::V2::Client

    CATALOG_PATH = '/v2/catalog'.freeze

    def initialize(attrs)
      @http_client = ServiceBrokers::V2::HttpClient.new(attrs)
    end
    ...
    rescue VCAP::CloudController::ServiceBrokers::V2::ServiceBrokerConflict => e
    ...
    def parse_response(method, path, response)
      ...
      case code
        ...
        when 200..299
          ...
          unless response_hash.is_a?(Hash)
            raise ServiceBrokers::V2::ServiceBrokerResponseMalformed.new(uri.to_s, method, response)
          end

          return response_hash

        when HTTP::Status::UNAUTHORIZED
          raise ServiceBrokers::V2::ServiceBrokerApiAuthenticationFailed.new(uri.to_s, method, response)

        when 409
          raise ServiceBrokers::V2::ServiceBrokerConflict.new(uri.to_s, method, response)
      ...
      raise ServiceBrokers::V2::ServiceBrokerBadResponse.new(uri.to_s, method, response)
    end
