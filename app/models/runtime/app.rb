  ...
  class App < Sequel::Model
    ...
    def validation_policies
      [
        ...
        MaxInstanceMemoryPolicy.new(self, organization, :instance_memory_limit_exceeded),
        MaxInstanceMemoryPolicy.new(self, space, :space_instance_memory_limit_exceeded),
