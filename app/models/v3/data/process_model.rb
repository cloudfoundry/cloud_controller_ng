...
module VCAP::CloudController
  ...
  class ProcessModel < Sequel::Model(:apps)
    ...
    one_to_many :droplets, :key=>:app_id
    one_to_many :service_bindings, :key=>:app_id
    ...
    many_to_one :stack
    many_to_many :routes, before_add: :validate_route, after_add: :handle_add_route, after_remove: :handle_remove_route, :join_table=>:apps_routes, :left_key=>:app_id
