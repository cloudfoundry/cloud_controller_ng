  ...
  module V3
    class ServiceCredentialBindingAppCreate < V3::ServiceBindingCreate
      ...
      def too_many_bindings!
        raise UnprocessableCreate.new("The app has too many bindings to this service instance (limit: #{max_bindings_per_app_service_instance}). Consider deleting existing or failed bindings.")
      end
