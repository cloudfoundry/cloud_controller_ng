...
module VCAP::CloudController
  module Presenters
    module V3
      class AppFullSummaryPresenter < AppPresenter
        ...
        def initialize(
          ...
          super(resource, show_secrets: show_secrets, decorators: decorators)
        end
        ...
        def build_routes_list
          routes.map do |resource|
            RoutePresenter.new(resource).to_hash
          end
        end
      end
    end
