...
module VCAP::CloudController
  class ProcessScaleMessage < BaseMessage
    register_allowed_keys [:instances, :memory_in_mb, :disk_in_mb, :log_quota_in_bps]
    ...
    validates :log_quota_in_bps, numericality: { only_integer: true, greater_than_or_equal_to: -1, less_than_or_equal_to: MAX_DB_BIGINT }, allow_nil: true
  end
end
