...
module VCAP::CloudController
  class QuotasAppsMessage < BaseMessage
    register_allowed_keys [:total_memory_in_mb, :per_process_memory_in_mb, :total_instances, :per_app_tasks, :log_limit_in_bytes_per_second]
    ...
    validates :log_limit_in_bytes_per_second,
