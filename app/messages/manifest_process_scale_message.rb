...
module VCAP::CloudController
  class ManifestProcessScaleMessage < BaseMessage
    register_allowed_keys [:instances, :memory, :disk_quota, :log_quota, :type]
    INVALID_MB_VALUE_ERROR = 'must be greater than 0MB'.freeze
    # NOTE: -1 is valid for log_quota representing unlimited, that conversion
    # will be complete prior to this validation
    INVALID_QUOTA_VALUE_ERROR = 'must be an integer greater than or equal to 0Bs'.freeze
    ...
    validates :log_quota, numericality: { only_integer: true, greater_than_or_equal_to: -1, message: INVALID_QUOTA_VALUE_ERROR }, allow_nil: true
