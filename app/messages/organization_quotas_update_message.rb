...
module VCAP::CloudController
  class OrganizationQuotasUpdateMessage < BaseMessage
    ...
    # Apps validations
    delegate :total_memory_in_mb, :per_process_memory_in_mb, :total_instances, :per_app_tasks, :log_rate_limit_in_bytes_per_second, :graceful_shutdown to: :apps_limits_message
