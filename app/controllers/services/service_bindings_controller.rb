...
module VCAP::CloudController
  class ServiceBindingsController < RestController::ModelController
    ...
    def create
      ...
      raise CloudController::Errors::ApiError.new_from_details('NotAuthorized') unless PermissionsQueryer.new(SecurityContext.current_user).can_write_to_space?(app.space_guid)
    ...
    def delete(guid)
      ...
      raise CloudController::Errors::ApiError.new_from_details('NotAuthorized') unless
        PermissionsQueryer.new(SecurityContext.current_user).can_write_to_space?(service_binding.space.guid)
