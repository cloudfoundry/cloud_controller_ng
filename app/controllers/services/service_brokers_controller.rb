...
module VCAP::CloudController
  ...
  class ServiceBrokersController < RestController::ModelController
    ...
    def create
      ...
      @services_event_repository.create_broker_event('audit.broker.create', broker, params)
    ...
    def update(guid)
      ...
      @services_event_repository.create_broker_event('audit.broker.update', broker, params)
    ...
    def delete(guid)
      ...
      @services_event_repository.create_broker_event('audit.broker.delete', broker, {})
