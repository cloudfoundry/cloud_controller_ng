...
gem "cf-message-bus", :git => "https://github.com/cloudfoundry/cf-message-bus.git", :ref => "dbc2fc6e"
gem "vcap_common", :git => "https://github.com/cloudfoundry/vcap-common.git", :ref => "8afde209"
gem "allowy"
